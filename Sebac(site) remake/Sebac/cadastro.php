...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $nomeUsuario = ($_POST['nome_usuario']); // Utilizando md5 para criptografar o nome de usuário
...
if ($result->num_rows > 0) {
    ...
    if ($conn->query($sql) === TRUE) {
        echo "<script>window.alert('Usuário cadastrado com sucesso!'); window.location.href='index.php';</script>";
    } else {
